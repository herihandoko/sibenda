...
<body>
  ...
  C84.573,16.331,86.05,20.549,84.365,24.062z"
        ...
        <h2>Maaf untuk ketidaknyamanannya.<br>Untuk menghubungi kami sementara itu, silakan kirim email</h2>
        <a href="mailto:email">diskominfo@bantenprov.go.id</a>
        <h2>atau telp <span>0821 1777 2226</span></h2>
        <h4><a href="{{ url('/') }}" style="color: blue;">Kembali Ke Beranda</a></h4>
    </div>
</body>
