                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.documentation.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <textarea class="form-control h-100" name="description" rows="3">{{ old('description') }}</textarea>
                                </div>
                            </div>
                            <hr>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="image_1" class="form-control" type="text" name="image_1" value="{{ old('image_1') }}">
                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="image_2" class="form-control" type="text" name="image_2" value="{{ old('image_2') }}">
                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="image_3" class="form-control" type="text" name="image_3" value="{{ old('image_3') }}">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="image_4" class="form-control" type="text" name="image_4" value="{{ old('image_4') }}">
                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="image_5" class="form-control" type="text" name="image_5" value="{{ old('image_5') }}">
                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="image_6" class="form-control" type="text" name="image_6" value="{{ old('image_6') }}">
                                        </div>
