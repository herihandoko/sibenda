    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('admin.master.jenis-hunian.update', $jenisHunian->id)}}" method="POST">
                            @csrf
                            @method('POST')
                            <div class="form-group">
                                <label for="">Nama</label>
                                <input type="text" class="form-control" name="name" value="{{$jenisHunian->name}}" required>
                            </div>
