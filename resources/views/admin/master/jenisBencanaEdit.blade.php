    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.master.jenis-bencana.update', $jenisBencana->id) }}" method="POST">
                            @csrf
                            @method('POST')
                            <div class="form-group">
                                <label for="">Nama</label>
                                <input type="text" class="form-control" name="name" value="{{ $jenisBencana->name }}"
                                    required>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="icon" class="form-control" type="text" name="icon" value="{{ $jenisBencana->icon }}">
                                </div>
                            </div>
