    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.data.data-bencana.update', $dataBencana->id) }}" method="POST">
                            @csrf
                            @method('POST')
                            {{-- <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="kode"
                                            value="{{ $dataBencana->kode }}" autofocus readonly>
                                    </div>
                                </div>
                            </div> --}}
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control sel" name="jenis_bencana_id" id="jenis_bencana_id"
                                            ...
                                            @foreach (App\Models\Master\JenisBencana::where('is_deleted', 0)->get() as $category)
                                                <option @if ($category->id == $dataBencana->jenis_bencana_id) selected @endif
                                                    value="{{ $category->id }}">
                                                    {{ $category->name }}
                                                </option>
                                            @endforeach
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="tgl_kejadian"
                                            value="{{ $dataBencana->tgl_kejadian }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="time" class="form-control" name="jam_kejadian"
                                            value="{{ $dataBencana->jam_kejadian }}" required>
                                    </div>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                <h6><span class="col-md-12">Lokasi Bencana</span></h6>&nbsp;<a id="btn-add-lokasi-bencana"
                                    ...
                                    data-value="{{ $lokasiBencana->count() == 0 ? 0 : $lokasiBencana->count() - 1 }}"><i
                                        class="fa fa-plus-circle"></i>Add Lokasi</a>
                            </div>
                            <div class="col-md-12 col-lokasi-bencana">
                                ...
                                @if ($lokasiBencana->count() > 0)
                                    @foreach ($lokasiBencana as $key => $val)
                                        <div class="row row-lokasi-bencana" id="row-lokasi-bencana-{{ $rows }}">
                                            <input type="hidden" id="hidden-kabupaten_{{ $rows }}"
                                                value="{{ $val->kabupaten }}">
                                            <input type="hidden" id="hidden-kecamatan_{{ $rows }}"
                                                value="{{ $val->kecamatan }}">
                                            <input type="hidden" id="hidden-kelurahan_{{ $rows }}"
                                                value="{{ $val->kelurahan }}">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    @php
                                                    ...
                                                    @endphp
                                                    <select class="form-control sel-provinsi"
                                                        name="provinsi[{{ $rows }}]"
                                                        id="provinsi_{{ $rows }}" required>
                                                        <option value="" disabled>-- Pilih --</option>
                                                        @foreach ($provinces->where('code', 36) as $item)
                                                            <option value="{{ $item->id ?? '' }}"
                                                                {{ $item->id == $val->provinsi ? 'selected' : '' }}>
                                                                {{ $item->name ?? '' }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <select class="form-control sel-kabupaten"
                                                        name="kabupaten[{{ $rows }}]"
                                                        id="kabupaten_{{ $rows }}" required>
                                                        <option value="" disabled selected>-- Pilih --</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <select class="form-control sel-kecamatan"
                                                        name="kecamatan[{{ $rows }}]"
                                                        id="kecamatan_{{ $rows }}" required>
                                                        <option value="" disabled selected>-- Pilih --</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <select class="form-control sel-kelurahan"
                                                        name="kelurahan[{{ $rows }}]"
                                                        id="kelurahan_{{ $rows }}" required>
                                                        <option value="" disabled selected>-- Pilih --</option>
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group mb-3">
                                                        <input type="text" class="form-control"
                                                            name="lokasi[{{ $rows }}]"
                                                            id="lokasi_{{ $rows }}" placeholder="Kp./Link."
                                                            aria-label="Lokasi" aria-describedby="basic-addon2" required
                                                            value="{{ $val->lokasi }}">
                                                        <input type="hidden" class="form-control"
                                                            name="latlng[{{ $rows }}]"
                                                            id="latlng_{{ $rows }}" placeholder="LatLng"
                                                            aria-label="Recipient's lat lng"
                                                            aria-describedby="basic-addon2" required
                                                            value="{{ $val->lat }},{{ $val->long }}">
                                                        <div class="input-group-append">
                                                            <button class="btn btn-outline-secondary btn-map-lat-lng"
                                                                type="button" value="{{ $rows }}"><i
                                            ...
                                            <div class="form-group">
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control"
                                                        name="lokasi[{{ $rows }}]"
                                                        id="lokasi_{{ $rows }}" placeholder="Kp./Link."
                                                        aria-label="Recipient's lat lng" aria-describedby="basic-addon2"
                                                        required>
                                                    <input type="hidden" class="form-control"
                                                        name="latlng[{{ $rows }}]"
                                                        id="latlng_{{ $rows }}" placeholder="LatLng"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="luas_genangan"
                                            value="{{ $dataBencana->luas_genangan }}" placeholder="m2">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="tinggi_genangan"
                                            value="{{ $dataBencana->tinggi_genangan }}" placeholder="cm">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                {{-- <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="kondisi_cuaca"
                                            value="{{ $dataBencana->kondisi_cuaca }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="potensi_susulan"
                                            value="{{ $dataBencana->potensi_susulan }}" required>
                                    </div>
                                </div> --}}
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="penyebab_bencana"
                                            value="{{ $dataBencana->penyebab_bencana }}" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control h-100" name="deskripsi_bencana" rows="3">{{ $dataBencana->deskripsi_bencana }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="akses_lokasi" id="akses_lokasi" required>
                                            <option value="" disabled selected>-- Pilih --</option>
                                            <option value="Tersedia" @if ($dataBencana->akses_lokasi == 'Tersedia') selected @endif>
                                                Tersedia</option>
                                            <option value="Tidak Tersedia"
                                                @if ($dataBencana->akses_lokasi == 'Tidak Tersedia') selected @endif>Tidak Tersedia</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="sarana_trans"
                                            value="{{ $dataBencana->sarana_trans }}" required>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="jalur_komunikasi_id" required>
                                            ...
                                            @foreach (App\Models\Master\JalurKomunikasi::where('is_deleted', 0)->get() as $jalurKomunikasi)
                                                <option @if ($jalurKomunikasi->id == $dataBencana->jalur_komunikasi_id) selected @endif
                                                    value="{{ $jalurKomunikasi->id }}">
                                                    {{ $jalurKomunikasi->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="keadaan_listrik" required>
                                            <option value="" disabled selected>-- Pilih --</option>
                                            <option value="Tersedia" @if ($dataBencana->keadaan_listrik == 'Tersedia') selected @endif>
                                                Tersedia</option>
                                            <option value="Tidak Tersedia"
                                                @if ($dataBencana->keadaan_listrik == 'Tidak Tersedia') selected @endif>Tidak Tersedia</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="keadaan_air" required>
                                            <option value="" disabled selected>-- Pilih --</option>
                                            <option value="Tersedia" @if ($dataBencana->keadaan_air == 'Tersedia') selected @endif>
                                                Tersedia</option>
                                            <option value="Tidak Tersedia"
                                                @if ($dataBencana->keadaan_air == 'Tidak Tersedia') selected @endif>Tidak Tersedia</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="faskes"
                                            value="{{ $dataBencana->faskes }}" required>
                                    </div>
                                </div>
                            </div> --}}
                            <div class="row">
...
@push('script')
    ...
    <script type="text/javascript">
        ...
        var _coutLokasi = parseInt("{{ $lokasiBencana->count() }}");
        var _row = 0;
        for (_row; _row < _coutLokasi; _row++) {

            var _prov = $('#provinsi_' + _row).val();
            onChangeSelect('{{ route('admin.cities') }}', _prov, 'kabupaten_' + _row);

            var _kab = $('#hidden-kabupaten_' + _row).val();
            onChangeSelect('{{ route('admin.districts') }}', _kab, 'kecamatan_' + _row);

            var _kec = $('#hidden-kecamatan_' + _row).val();
            onChangeSelect('{{ route('admin.villages') }}', _kec, 'kelurahan_' + _row);
        ...
        $('a#btn-add-lokasi-bencana').click(function(e) {
            ...
            _htmlRow += '<input type="text" class="form-control" name="lokasi[' + _row + ']" id="lokasi_' + _row +
                '" placeholder="Lokasi" aria-label="Recipients Lat Lng" aria-describedby="basic-addon2" required>';
