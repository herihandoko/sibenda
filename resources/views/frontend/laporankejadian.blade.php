    ...
    <section id="bizland" class="d-flex align-items-center" style="padding: 20px 0;">
        <div class="container">
            <div class="section-title">
                ...
                <p>Data Laporan Kejadian Bencana di Provinsi Banten</p>
            </div>
            <div class="my-3">
                @if (session('success'))
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-3">
                                    ...
                                    <div class="input-group" style="height: 38px !important;">
                                        ...
                                        <input type="text" class="form-control" placeholder="Masukan Jenis Bencana"
                                            aria-label="jenis_bencana" name="jenis_bencana" id="jenis_bencana">
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-3">
                                ...
                                <div class="col-sm-12 col-md-3 text-center">
                                    <div class="row" style="padding-top: 20px;">
                                        <div class="col-md-6 col-sm-12 mt-1">
                                            <button type="button" class="btn btn-primary" id="btn-filter-data-bencana"
                                                style="width: 100%;">Cari</button>
                                        </div>
                                        <div class="col-md-6 col-sm-12 mt-1">
                                            <a href="{{ route('laporankejadian.add') }}" class="btn btn-success"
                                                style="width: 100%;">Buat Laporan</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            var _tableContent = $('#data-bencana-table').DataTable({
                ...
                buttons: [
                    'copy', 'csv', 'excel',
                    {
                        ...
                        text: 'Simpan PDF',
                        header: true,
                        title: 'Data Laporan Kejadian Bencana',
                ...
                autoWidth: false,
                ajax: {
                    url: "{{ route('laporankejadian.fetch') }}",
                    type: "GET",
                    data: function(data) {
                        const _filter = {};
                ...
                columns: [{
                    ...
                    {
                        data: 'dampak_bencana_rr',
                        name: 'dampak_bencana_rr'
                    },
                    {
                        data: 'dampak_bencana_rs',
                        name: 'dampak_bencana_rs'
                    },
                    {
                        data: 'dampak_bencana_rb',
                        name: 'dampak_bencana_rb'
                    },
                    {
                        data: 'korban_jiwa_md',
                        name: 'korban_jiwa_md'
            ...
            $('body').on('click', '.btn-detail-lokasi', function(e) {
